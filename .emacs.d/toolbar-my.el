; Paste this as 'toolbar-my.el' in '~/.emacs.d', and put the icons in '~/.emacs.d/icons'.
; This line needs to be inserted in .emacs: (load-file "~/.emacs.d/toolbar.el-my")
...
(setq my-toolbar-icon-directory (expand-file-name "~/.emacs.d/icons/"))
