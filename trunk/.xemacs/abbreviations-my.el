...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("couts" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 729)
    ("cout" "cout << " nil 167)
    ("xxx" "exit(0);" indent-for-tab-command 73)
    ("coutp" "cout << \"\" << endl;" (lambda nil (interactive) (search-backward "\"")) 142)
    ("catch" "catch" c-electric-continued-statement 0)
    ("sparce" "sparse" nil 1)
    ("if" "" c++-if 517)
    ("\\incl" "#include \"\"" backward-char 25)
    ("ints" "int*" nil 2)
    ("\\si" ".size()" nil 2)
    ("\\ijk" "[i][j][k]" nil 0)
    ("doss" "double ** " nil 4)
    ("ndd" "new double []" backward-char 35)
    ("\\inc" "#include <>" backward-char 10)
    (";x" "exit(0);" nil 5)
    ("xx0" "exit(0);" nil 1)
    ("do" "double " nil 668)
    ("\\us" "Util_AssertString(\"\");" (lambda nil (interactive) (search-backward "\"")) 0)
    ("\\ub" "Util_AssertBool(\"\");" (lambda nil (interactive) (search-backward "\"")) 0)
    ))

(define-abbrev-table 'cperl-mode-abbrev-table '(
    (";u" "undef $/;" nil 0)
    ("sg" "" subst-globally 272)
...
(define-abbrev-table 'f90-mode-abbrev-table '(
    ...
    ("`fl" "forall" nil 0)
    ("`na" "namelist" nil 0)
    ("print" "print *, \"\"" (lambda nil (interactive) (search-backward "\"")) 37)
    ("`t" "type" nil 0)
    ))
