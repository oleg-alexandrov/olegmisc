...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("else" "else" c-electric-continued-statement 78)
    ("couts" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 638)
    ("cout" "cout << " nil 161)
    ("xxx" "exit(0);" indent-for-tab-command 66)
    ("coutp" "cout << \"\" << endl;" (lambda nil (interactive) (search-backward "\"")) 142)
    ("catch" "catch" c-electric-continued-statement 0)
    ("if" "" c++-if 434)
    ("sparce" "sparse" nil 1)
    ("ints" "int*" nil 2)
    ("\\incl" "#include \"\"" backward-char 19)
    ("doss" "double ** " nil 4)
    ("\\ijk" "[i][j][k]" nil 0)
    ("ndd" "new double []" backward-char 35)
    ("\\inc" "#include <>" backward-char 6)
    ("xx0" "exit(0);" nil 1)
    (";x" "exit(0);" nil 5)
    ("do" "double " nil 633)
    ))
