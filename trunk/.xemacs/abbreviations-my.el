...
(define-abbrev-table 'matlab-mode-abbrev-table '(
    ("dsp" "disp(sprintf('%'));" (lambda nil (indent-according-to-mode) (search-backward "%")) 176)
    (";dl" "dlmread" nil 0)
    (";p" "plot(" nil 0)
    ...
    ("xxx" "break;" nil 3)
    ("if" "" matlab-if 221)
    ("fch" "figure(1); clf; hold on;" nil 22)
...
" cperl-indent-command 82)
    ...
    ("if" "" perl-if 325)
    ("\\ofr" "open(FILE, \"<\");" (lambda nil (interactive) (search-backward "\"")) 17)
    ("foreach" "" perl-foreach 168)
    (";x" "exit(0);" nil 0)
    ("print" "" perl-print 576)
...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("else" "else" c-electric-continued-statement 65)
    ("couts" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 880)
    ("cout" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 793)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 8)
