...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("\\f" ".front()" nil 0)
    ("\\gd" "Geom_Dbu" nil 104)
    ("\\inc" "#include <>" backward-char 54)
    ("\\incl" "#include \"\"" backward-char 45)
    ("\\n" "NULL" nil 0)
    ("\\ofs" "ofstream (\"\");" (lambda nil (interactive) (search-backward "(")) 2)
    ("\\p" ".push_back();" (lambda nil (interactive) (search-backward ")")) 0)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 42)
    ("\\rs" ".resize()" backward-char 42)
    ("\\si" ".size()" nil 144)
    ("\\sr" "std::string" nil 1)
    ("\\st" "std::string" nil 1)
    ...
    ("\\ubf" "Util_AssertBool(false);" nil 140)
    ("\\ui" "unsigned int " nil 17)
    ("\\us" "Util_AssertCndString( ,  );" (lambda nil (interactive) (search-backward ",")) 3)
    ("\\uw" "Util_StopWatch watch;" nil 1)
    ("\\vd" "vector<double> " nil 87)
    ("\\vg" "vector<Geom_Dbu> " nil 0)
    ("\\vi" "vector<int> " nil 16)
    ...
    ("cerr" "cerr << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 864)
    ("cin" "cin >> " nil 9)
    ("co2" "cout.precision(20);" nil 1)
    ("cout" "cout <<  << endl;" (lambda nil (interactive) (search-backward " <<") (c-indent-command)) 838)
    ("coute" "cout << endl;" nil 11)
    ("coutp" "cout.precision();" nil 1)
    ("couts" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 1207)
    ("else" "else" c-electric-continued-statement 22)
    ("for" "" c++-for 887)
    ("if" "" c++-if 1170)
    ("ints" "int*" nil 2)
    ...
    ("teh" "the " nil 46)
    ("uns" "using namespace std;" nil 22)
...
(define-abbrev-table 'cperl-mode-abbrev-table '(
    ...
    ("\\ar" "$ARGV[]" (lambda nil (interactive) (forward-char -1)) 22)
    ("\\cf" "close(FILE);" cperl-indent-command 127)
    ("\\f" "<FILE>" nil 43)
    ("\\m" "=~ //" (lambda nil (interacive) (backward-char 1)) 0)
    ("\\of" "open (FILE, \":utf8\", \"\");" (lambda nil (interactive) (backward-char 3)) 56)
    ("\\ofr" "open(FILE, \"<\");" (lambda nil (interactive) (search-backward "\"")) 52)
    ("\\ofw" "open(FILE, \">\");" (lambda nil (interactive) (search-backward "\"")) 34)
    ("\\pf" "print FILE \"\\n\";" (lambda nil (interactive) (forward-char -4)) 65)
    ("\\sp" "split(\"\\n\", )" (lambda nil (interactive) (forward-char -1)) 20)
    ...
    ("else" "" perl-else 145)
    ("for" "" perl-for 127)
    ("foreach" "" perl-foreach 197)
    ("if" "" perl-if 410)
    ("opf" "open (FILE, \":utf8\", \"\");" (lambda nil (interactive) (backward-char 3)) 1)
    ("print" "" perl-print 738)
    ("sg" "" subst-globally 354)
...
(define-abbrev-table 'matlab-mode-abbrev-table '(
    ...
    ("dsp" "disp(sprintf('%'));" (lambda nil (indent-according-to-mode) (search-backward "%")) 241)
    ("dsr" "display(sprintf('%0.9g'))" nil 1)
    ("fch" "figure(); clf; hold on;" (lambda nil (interactive) (search-backward ")")) 16)
    ("for" "" matlab-for 330)
    ("if" "" matlab-if 279)
...
(define-abbrev-table 'python-mode-abbrev-table '(
    ("print" "print \"\"" (lambda nil (interactive) (search-backward "\"")) 28)
    ))
