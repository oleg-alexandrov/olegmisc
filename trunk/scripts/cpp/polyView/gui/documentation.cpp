...
"<br>\n"
"PolyView can also do basic polygon editing, such as creating/deleting/moving individual polygons and polygon sets, adding/removing/modifying vertices, as well as wholesale changes on the entire set of currently open polygons, such as cutting them to a given box or applying shift/scale/rotation transformations.<br>\n"
"<br>\n"
