...
(custom-set-faces
 ...
 '(font-latex-sectioning-0-face ((t (:size "" :family ""))))
 '(font-latex-sectioning-1-face ((t (:size "" :family "" :bold nil))))
 '(font-latex-sectioning-2-face ((t (:size ""))))
 '(font-latex-sectioning-3-face ((t (:size ""))))
 '(font-latex-sectioning-4-face ((t nil)))
 '(font-latex-sectioning-5-face ((((class color) (background light)) (:foreground "blue4" :bold t))))
 '(font-latex-sedate-face ((((class color) (background light)) (:foreground "gold"))))
 '(font-latex-slide-title-face ((t (:bold nil :family "helvetica"))))
 ...
 '(modeline-buffer-id ((t (:foreground "red3" :background "#DBDBDB"))) t)
 '(modeline-mousable ((t (:foreground "black" :background "#DBDBDB"))) t)
