...
(define-abbrev-table 'sh-mode-abbrev-table '(
    ...
    ("\\td" "# TODO(oalexan1): " nil 1)
    ("pl" "perl -pi -e \"s###g\"" (lambda nil (interactive) (search-backward "##")) 60)
    ))
...
(define-abbrev-table 'python-mode-abbrev-table '(
    ("\\xx" "sys.exit(1)" nil 5)
    ("\\td" "# TODO(oalexan1): " nil 2)
    ("printp" "print()" (lambda nil (interactive) (search-backward ")")) 66)
    ("print" "print(\"\")" (lambda nil (interactive) (search-backward "\"")) 165)
    ))
...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("while" "while" c-electric-continued-statement 0)
    ("uns" "using namespace std;" nil 41)
    ("\\sz" "sizeof()" (lambda nil (interactive) (search-backward ")")) 5)
    ...
    ("\\td" "// TODO(oalexan1): " nil 102)
    ("\\st" "std::string " nil 115)
    ("else" "else" c-electric-continued-statement 2)
    ("\\sr" "std::string " nil 1)
    ("couts" "std::cout << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 3376)
    ("cout" "std::cout <<  << std::endl;" (lambda nil (interactive) (search-backward " <<") (c-indent-command)) 941)
    ("\\spr" "sprintf(, \"%d\", );" (lambda nil (interactive) (beginning-of-line) (search-forward "\"")) 11)
    ("\\sp" "std::shared_ptr" nil 6)
    ("xxx" "xxx " nil 24)
    ("coutp" "std::cout.precision();" (lambda nil (interactive) (search-backward ")") (c-indent-command)) 53)
    ("\\os" "std::ostringstream " nil 0)
    ("catch" "catch" c-electric-continued-statement 0)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 203)
    ("\\ofs" "std::ofstream (\"\");" (lambda nil (interactive) (search-backward "(")) 14)
    ("\\lfs" "LOG(FATAL) << \"\\n\";" (lambda nil (interactive) (backward-char 4)) 34)
    ("if" "" c++-if 2522)
    ("\\sti" "static_cast<int>" nil 27)
    ("\\lf" "LOG(FATAL) << " nil 9)
    ("\\vw" "vw_out() << \"\\n\";" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (backward-char 2) (c-indent-command)) 2)
    ("\\ifs" "std::ifstream " nil 2)
    ("ints" "int*" nil 3)
    ("\\incl" "#include \"\"" backward-char 86)
    ("\\do" "double " nil 1024)
    ("\\si" ".size()" nil 495)
    ("\\vs" "std::vector<std::string>" nil 11)
    ("\\std" "static_cast<double>" nil 13)
    ("\\inc" "#include <>" backward-char 146)
    ("\\if0" "#if 0" nil 1)
    ("\\v3" "Vector3 " nil 21)
    ("coute" "std::cout << std::endl;" nil 53)
    ("\\rs" ".resize()" backward-char 107)
    ("\\v2" "Vector2 " nil 25)
    ("cerr" "std::cerr << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 905)
