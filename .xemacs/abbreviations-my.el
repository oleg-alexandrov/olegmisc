...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ("\\x" "exit(0);" nil 5)
    ("\\vi" "vector<int> " nil 0)
    ("\\ubf" "Util_AssertBool(false);" nil 8)
    ("cin" "cin >> " nil 8)
    ...
    ("else" "else" c-electric-continued-statement 0)
    ("cout" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 769)
    ("catch" "catch" c-electric-continued-statement 0)
    ("if" "" c++-if 592)
    ...
    ("\\rs" ".resize()" nil 7)
    ("cerr" "cerr << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 769)
    ))
