...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("uns" "using namespace std;" nil 40)
    ...
    ("\\ei" "#endif" nil 1)
    ("\\st" "std::string " nil 56)
    ("\\td" "// TODO(oalexan1): " nil 70)
    ("\\sr" "std::string " nil 1)
    ("else" "else" c-electric-continued-statement 1)
    ("couts" "std::cout << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 3121)
    ("\\spr" "sprintf(, \"%d\", );" (lambda nil (interactive) (beginning-of-line) (search-forward "\"")) 11)
    ("cout" "std::cout <<  << std::endl;" (lambda nil (interactive) (search-backward " <<") (c-indent-command)) 937)
    ("xxx" "xxx " nil 24)
    ("\\os" "std::ostringstream " nil 0)
    ("coutp" "std::cout.precision();" (lambda nil (interactive) (search-backward ")") (c-indent-command)) 44)
    ("\\ofs" "std::ofstream (\"\");" (lambda nil (interactive) (search-backward "(")) 14)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 196)
    ("catch" "catch" c-electric-continued-statement 0)
    ("\\vw" "vw_out() << \"\\n\";" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (backward-char 2) (c-indent-command)) 1)
    ("\\lf" "LOG(FATAL) << " nil 8)
    ("\\sti" "static_cast<int>" nil 27)
    ("if" "" c++-if 2396)
    ("\\lfs" "LOG(FATAL) << \"\\n\";" (lambda nil (interactive) (backward-char 4)) 17)
    ("\\do" "double " nil 1010)
    ("\\incl" "#include \"\"" backward-char 86)
    ("ints" "int*" nil 3)
    ("\\ifs" "std::ifstream " nil 0)
    ("\\si" ".size()" nil 464)
    ("\\vs" "std::vector<std::string>" nil 7)
    ("\\std" "static_cast<double>" nil 13)
    ("\\inc" "#include <>" backward-char 138)
    ("\\rs" ".resize()" backward-char 106)
    ("coute" "std::cout << std::endl;" nil 50)
    ("\\v3" "Vector3 " nil 21)
    ("\\if0" "#if 0" nil 1)
...
(define-abbrev-table 'python-mode-abbrev-table '(
    ("\\xx" "sys.exit(1)" nil 2)
    ("\\td" "# TODO(oalexan1): " nil 0)
    ("printp" "print()" (lambda nil (interactive) (search-backward ")")) 66)
    ("print" "print(\"\")" (lambda nil (interactive) (search-backward "\"")) 131)
    ))
...
(define-abbrev-table 'fundamental-mode-abbrev-table '(
    ("\\nr" ":numref:``" backward-char 42)
    ("\\ci" ":cite:``" backward-char 36)
