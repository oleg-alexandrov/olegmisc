...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("dos" "double* " nil 205)
    ("cin" "cin >> " nil 8)
    ("\\vd" "vector<double> " nil 19)
    ("\\cl" ".close();" nil 1)
    ("\\us" "Util_AssertString(\"\");" (lambda nil (interactive) (search-backward "\"")) 2)
    (",." " << endl;" nil 158)
    ("\\ui" "unsigned int " nil 4)
    ...
    ("couts" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 746)
    ("cout" "cout << " nil 170)
    ("xxx" "exit(0);" indent-for-tab-command 74)
    ("coutp" "cout << \"\" << endl;" (lambda nil (interactive) (search-backward "\"")) 142)
    ("catch" "catch" c-electric-continued-statement 0)
    ("\\sti" "static_cast<int>" nil 8)
    ("sparce" "sparse" nil 1)
    ("if" "" c++-if 551)
    ("\\incl" "#include \"\"" backward-char 26)
    ("ints" "int*" nil 2)
    ("\\si" ".size()" nil 10)
    ("\\ijk" "[i][j][k]" nil 0)
    ("doss" "double ** " nil 4)
    ("ndd" "new double []" backward-char 35)
    ("\\inc" "#include <>" backward-char 11)
    ("\\rs" ".resize()" nil 1)
    (";x" "exit(0);" nil 5)
    ("xx0" "exit(0);" nil 1)
    ("do" "double " nil 682)
...
" cperl-indent-command 76)
    ...
    ("else" "" perl-else 114)
    ("\\pf" "print FILE \"\\n\";" (lambda nil (interactive) (forward-char -4)) 43)
    ("\\ofw" "open(FILE, \">\");" nil 19)
    ("xxx" "exit(0);" nil 145)
    ("\\ag" "$ARGV[];" (lambda nil (interactive) (forward-char -2)) 1)
    ("\\ofr" "open(FILE, \"<\");" nil 14)
    ("if" "" perl-if 306)
    (";x" "exit(0);" nil 0)
    ("foreach" "" perl-foreach 161)
    ("\\of" "open (FILE, \":utf8\", \"\");" (lambda nil (interactive) (backward-char 3)) 52)
    ("print" "" perl-print 546)
    ))
