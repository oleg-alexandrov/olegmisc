...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ("\\x" "exit(0);" nil 5)
    ("\\vi" "vector<int> " nil 2)
    ("\\ubf" "Util_AssertBool(false);" nil 52)
    ("\\dos" "double* " nil 0)
    ("cin" "cin >> " nil 8)
    ...
    ("else" "else" c-electric-continued-statement 71)
    ("couts" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 897)
    ("cout" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 797)
    ("catch" "catch" c-electric-continued-statement 4)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 9)
    ("\\sti" "static_cast<int>" nil 25)
    ("if" "" c++-if 745)
    ("\\incl" "#include \"\"" backward-char 28)
    ("ints" "int*" nil 2)
    ("\\do" "double " nil 747)
    ("\\si" ".size()" nil 57)
    ("\\std" "static_cast<double>" nil 12)
    ("\\inc" "#include <>" backward-char 16)
    ("\\rs" ".resize()" nil 11)
    ("coute" "cout << endl;" nil 9)
    ("cerr" "cerr << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 809)
    ))

(define-abbrev-table 'cperl-mode-abbrev-table '(
    (";u" "undef $/;" nil 0)
    ("sg" "" subst-globally 286)
    ("ssg" "" tilde-subst-globally 42)
    ("\\m" "=~ //" (lambda nil (interacive) (backward-char 1)) 0)
    ("\\cf" "close(FILE);
" cperl-indent-command 83)
    ...
    ("else" "" perl-else 117)
    ("\\pf" "print FILE \"\\n\";" (lambda nil (interactive) (forward-char -4)) 46)
    ("\\ofw" "open(FILE, \">\");" (lambda nil (interactive) (search-backward "\"")) 22)
    ("xxx" "exit(0);" nil 146)
    ("\\ag" "$ARGV[];" (lambda nil (interactive) (forward-char -2)) 1)
    ("\\spn" "split(\"\\n\", );" (lambda nil (interactive) (search-backward ")")) 0)
    ("\\ofr" "open(FILE, \"<\");" (lambda nil (interactive) (search-backward "\"")) 18)
    ("if" "" perl-if 325)
    (";x" "exit(0);" nil 0)
    ("foreach" "" perl-foreach 168)
    ("\\of" "open (FILE, \":utf8\", \"\");" (lambda nil (interactive) (backward-char 3)) 53)
    ("print" "" perl-print 577)
    ))
...
(define-abbrev-table 'matlab-mode-abbrev-table '(
    ("dsp" "disp(sprintf('%'));" (lambda nil (indent-according-to-mode) (search-backward "%")) 182)
    (";dl" "dlmread" nil 0)
    (";p" "plot(" nil 0)
    ...
    ("xxx" "break;" nil 3)
    ("if" "" matlab-if 227)
    ("fch" "figure(); clf; hold on;" (lambda nil (interactive) (search-backward ")")) 0)
