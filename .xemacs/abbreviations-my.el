...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("\\th" "vw::vw_throw(vw::ArgumentErr() << \".\\n\");" (lambda nil (interactive) (backward-char 6)) 42)
    ("\\ws" "watch.Start();" nil 3)
    ("\\wp" "watch.Print();" nil 1)
    ("\\args" "std::cout << \"\\n\\n\"; for (int s = 0; s < argc; s++) std::cout << argv[s]  << ' '; std::cout << \"\\n\\n\";" nil 1)
    ("\\str" "std::string " nil 3)
    ("\\ei" "#endif" nil 1)
    ("\\st" "std::string " nil 228)
    ("\\td" "// TODO(oalexan1): " nil 306)
    ("\\sr" "std::string " nil 1)
    ("else" "else" c-electric-continued-statement 38)
    ("couts" "std::cout << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 3947)
    ("\\sp" "std::shared_ptr" nil 6)
    ("\\spr" "sprintf(, \"%d\", );" (lambda nil (interactive) (beginning-of-line) (search-forward "\"")) 11)
    ("cout" "std::cout <<  << std::endl;" (lambda nil (interactive) (search-backward " <<") (c-indent-command)) 958)
    ("xxx" "xxx " nil 25)
    ("\\os" "std::ostringstream " nil 0)
    ("coutp" "std::cout.precision();" (lambda nil (interactive) (search-backward ")") (c-indent-command)) 69)
    ("\\ofs" "std::ofstream (\"\");" (lambda nil (interactive) (search-backward "(")) 17)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 257)
    ("catch" "catch" c-electric-continued-statement 2)
    ("\\vw" "vw_out() << \"\\n\";" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (backward-char 2) (c-indent-command)) 10)
    ("\\lf" "LOG(FATAL) << " nil 10)
    ...
    ("ints" "int*" nil 4)
    ("\\ifs" "std::ifstream " nil 4)
    ("\\si" ".size()" nil 674)
    ("\\vs" "std::vector<std::string>" nil 29)
    ("\\std" "static_cast<double>" nil 13)
    ("\\inc" "#include <>" backward-char 184)
    ("\\rs" ".resize()" backward-char 117)
    ("coute" "std::cout << std::endl;" nil 73)
    ("\\v3" "Vector3 " nil 47)
    ("\\if0" "#if 0" nil 1)
    ("cerr" "std::cerr << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 906)
    ("\\v2" "Vector2 " nil 41)
...
(define-abbrev-table 'python-mode-abbrev-table '(
    ("\\xx" "sys.exit(1)" nil 34)
    ("\\ex" "raise Exception(\"\")" nil 1)
    ("\\td" "# TODO(oalexan1): " nil 15)
    ("printp" "print()" (lambda nil (interactive) (search-backward ")")) 66)
    ("print" "print(\"\")" (lambda nil (interactive) (search-backward "\"")) 375)
    ))
...
(define-abbrev-table 'sh-mode-abbrev-table '(
    ("\\x" "exit 0" nil 3)
    ("\\xx" "exit 0" nil 5)
    ("\\ms" "message(STATUS \"\")" (lambda nil (interactive) (search-backward "\"")) 0)
    ("\\pl" "perl -pi -e \"s###g\"" (lambda nil (interactive) (search-backward "##")) 59)
    ("\\td" "# TODO(oalexan1): " nil 23)
    ("\\xxx" "exit 0" nil 0)
    ("pl" "perl -pi -e \"s###g\"" (lambda nil (interactive) (search-backward "##")) 65)
    ))
...
(define-abbrev-table 'fundamental-mode-abbrev-table '(
    ("\\nr" ":numref:``" backward-char 172)
    ("\\ur" "` <>`_" nil 7)
    ("\\ci" ":cite:``" backward-char 39)
    ("\\td" "TODO(oalexan1): " nil 6)
    ("\\sec" ".. _:" backward-char 3)
    ))
