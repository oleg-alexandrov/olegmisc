...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("teh" "the " nil 81)
    ("\\nan" "std::numeric_limits<double>::quiet_NaN()" nil 0)
    ...
    ("\\ei" "#endif" nil 1)
    ("\\st" "std::string " nil 53)
    ("\\td" "// TODO(oalexan1): " nil 55)
    ("\\sr" "std::string " nil 1)
    ("else" "else" c-electric-continued-statement 1)
    ("couts" "std::cout << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 3072)
    ...
    ("\\inc" "#include <>" backward-char 137)
    ("\\rs" ".resize()" backward-char 106)
    ("coute" "std::cout << std::endl;" nil 48)
    ("\\v3" "Vector3 " nil 21)
    ("\\if0" "#if 0" nil 1)
