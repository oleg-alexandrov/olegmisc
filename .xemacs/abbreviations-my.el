...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("\\st" "std::string " nil 27)
    ("\\sr" "std::string " nil 1)
    ("else" "else" c-electric-continued-statement 11)
    ("couts" "std::cout << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 2453)
    ("\\spr" "sprintf(, \"%d\", );" (lambda nil (interactive) (beginning-of-line) (search-forward "\"")) 11)
    ("cout" "std::cout <<  << std::endl;" (lambda nil (interactive) (search-backward " <<") (c-indent-command)) 912)
    ("xxx" "xxx " nil 22)
    ("coutp" "std::cout.precision();" (lambda nil (interactive) (search-backward ")") (c-indent-command)) 25)
    ("\\ofs" "std::ofstream (\"\");" (lambda nil (interactive) (search-backward "(")) 14)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 172)
    ("catch" "catch" c-electric-continued-statement 9)
    ...
    ("\\inc" "#include <>" backward-char 128)
    ("\\rs" ".resize()" backward-char 100)
    ("coute" "std::cout << std::endl;" nil 40)
    ("\\v3" "Vector3 " nil 5)
