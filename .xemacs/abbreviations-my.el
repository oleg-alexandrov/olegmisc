...
(define-abbrev-table 'sh-mode-abbrev-table '(
    ("\\x" "exit 0" nil 3)
    ("\\xx" "exit 0" nil 6)
    ("\\ms" "message(STATUS \"\")" (lambda nil (interactive) (search-backward "\"")) 4)
    ("\\pl" "perl -pi -e \"s###g\"" (lambda nil (interactive) (search-backward "##")) 61)
    ("\\td" "# TODO(oalexan1): " nil 32)
    ("\\xxx" "exit 0" nil 0)
    ("pl" "perl -pi -e \"s###g\"" (lambda nil (interactive) (search-backward "##")) 80)
    ))
...
(define-abbrev-table 'python-mode-abbrev-table '(
    ("\\xx" "sys.exit(1)" nil 46)
    ("\\ex" "raise Exception(\"\")" nil 1)
    ("\\a" "sys.argv[]" (lambda nil (interactive) (search-backward "]")) 1)
    ("\\ar" "sys.argv[]" (lambda nil (interactive) (search-backward "]")) 2)
    ("\\td" "# TODO(oalexan1): " nil 17)
    ("printp" "print()" (lambda nil (interactive) (search-backward ")")) 66)
    ("print" "print(\"\")" (lambda nil (interactive) (search-backward "\"")) 486)
    ))
...
(define-abbrev-table 'cperl-mode-abbrev-table '(
    ...
    ("\\ar" "$ARGV[]" (lambda nil (interactive) (forward-char -1)) 31)
    ("\\sub" "sub  " (lambda nil (interactive) (perl-brace) (search-backward " {")) 0)
    ("else" "" perl-else 488)
    ("\\pf" "print FILE \"\\n\";" (lambda nil (interactive) (forward-char -4)) 71)
    ("\\ofw" "open(FILE, \">\");" (lambda nil (interactive) (search-backward "\"")) 41)
    ("\\sp" "split(\"\\n\", )" (lambda nil (interactive) (forward-char -1)) 33)
    ("xxx" "exit(0);" nil 184)
    ("\\ag" "$ARGV[];" (lambda nil (interactive) (forward-char -2)) 3)
    ("if" "" perl-if 495)
    ("\\spn" "split(\"\\n\", );" (lambda nil (interactive) (search-backward ")")) 1)
    ("\\ofr" "open(FILE, \"<\");" (lambda nil (interactive) (search-backward "\"")) 71)
    ("foreach" "" perl-foreach 231)
    (";x" "exit(0);" nil 0)
    ("print" "" perl-print 846)
...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("\\oss" "std::ostringstream" nil 1)
    ("\\cd" "complex<double>" nil 8)
    ("\\iss" "std::istringstream " nil 7)
    (",." " << std::endl;" nil 419)
    ("\\h" ".height()" nil 1)
    ...
    (",," " << ' ' << " nil 1273)
    ("\\e" "std::endl;" nil 12)
    ("paramter" "parameter" nil 4)
    ("\\c" ".clear();" nil 287)
    ("\\v30" "Vector3()" nil 2)
    ("for" "" c++-for 2429)
    ("\\is" "std::istringstream " nil 1)
    ("\\b" ".back()" nil 3)
    ("\\ts" ".transpose()" nil 1)
    ("\\ub" "Util_AssertBool(\"\");" (lambda nil (interactive) (search-backward "\"")) 0)
    ("\\tr" ".transpose()" nil 75)
    ("\\i6" "std::int64_t" nil 23)
    ("\\dnan" "std::numeric_limits<float>::quiet_NaN()" nil 1)
    ...
    ("\\en" ".end()" nil 3)
    ("while" "while" c-electric-continued-statement 0)
    ("uns" "using namespace std;" nil 42)
    ("\\sz" "sizeof()" (lambda nil (interactive) (search-backward ")")) 7)
    ("\\nan" "std::numeric_limits<double>::quiet_NaN()" nil 1)
    ("\\ar" "argv[]" (lambda nil (interactive) (backward-char 1)) 5)
    ("\\em" ".empty()" nil 88)
    ("\\ws" "watch.Start();" nil 3)
    ("\\th" "vw::vw_throw(vw::ArgumentErr() << \".\\n\");" (lambda nil (interactive) (backward-char 6)) 89)
    ("\\ei" "#endif" nil 1)
    ("\\str" "std::string " nil 3)
    ("\\args" "std::cout << \"\\n\\n\"; for (int s = 0; s < argc; s++) std::cout << argv[s]  << ' '; std::cout << \"\\n\\n\";" nil 1)
    ("\\wp" "watch.Print();" nil 1)
    ("\\td" "// TODO(oalexan1): " nil 505)
    ("\\st" "std::string " nil 314)
    ("else" "else" c-electric-continued-statement 5)
    ("\\sr" "std::string " nil 1)
    ("couts" "std::cout << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 4705)
    ("cout" "std::cout <<  << std::endl;" (lambda nil (interactive) (search-backward " <<") (c-indent-command)) 965)
    ("\\spr" "sprintf(, \"%d\", );" (lambda nil (interactive) (beginning-of-line) (search-forward "\"")) 11)
    ("\\sp" "std::shared_ptr" nil 6)
    ("xxx" "xxx " nil 29)
    ("coutp" "std::cout.precision();" (lambda nil (interactive) (search-backward ")") (c-indent-command)) 89)
    ("\\os" "std::ostringstream " nil 0)
    ("catch" "catch" c-electric-continued-statement 0)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 285)
    ("\\ofs" "std::ofstream (\"\");" (lambda nil (interactive) (search-backward "(")) 17)
    ("\\mat" "vw::Matrix<double>" nil 0)
    ("\\lfs" "LOG(FATAL) << \"\\n\";" (lambda nil (interactive) (backward-char 4)) 95)
    ("if" "" c++-if 3433)
    ("\\sti" "static_cast<int>" nil 27)
    ("\\lf" "LOG(FATAL) << " nil 18)
    ("\\vw" "vw_out() << \"\\n\";" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (backward-char 2) (c-indent-command)) 24)
    ("\\vv" "vw::Vector " nil 80)
    ("\\ifs" "std::ifstream " nil 5)
    ("ints" "int*" nil 4)
    ("\\incl" "#include \"\"" backward-char 86)
    ("\\do" "double " nil 1238)
    ("\\si" ".size()" nil 771)
    ("\\inf" "std::numeric_limits<double>::infinity()" nil 1)
    ("\\vs" "std::vector<std::string>" nil 39)
    ("\\std" "static_cast<double>" nil 13)
    ("\\se" "std::set<>" backward-char 0)
    ("\\inc" "#include <>" backward-char 208)
    ("\\if0" "#if 0" nil 1)
    ("\\v3" "vw::Vector3 " nil 128)
    ("coute" "std::cout << std::endl;" nil 82)
    ("\\rs" ".resize()" backward-char 122)
    ("\\v2" "vw::Vector2 " nil 68)
    ("cerr" "std::cerr << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 907)
    ("w" "vw::vw_out() << \"\\n\";" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 3072)
    ))
...
(define-abbrev-table 'fundamental-mode-abbrev-table '(
    ("\\nr" ":numref:``" backward-char 441)
    ("\\ur" "` <>`_" nil 13)
    ("\\ci" ":cite:``" backward-char 39)
    ("\\m" ":math:``" backward-char 1)
    ("\\ms" "message(STATUS \"\")" nil 0)
    ("\\url" "`val <http>`_" nil 3)
    ("\\td" "TODO(oalexan1): " nil 14)
    ("\\sec" ".. _:" backward-char 29)
    ))
