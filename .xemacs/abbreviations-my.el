...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("\\th" "vw::vw_throw(vw::ArgumentErr() << \".\\n\");" (lambda nil (interactive) (backward-char 6)) 71)
    ("\\ws" "watch.Start();" nil 3)
    ("\\wp" "watch.Print();" nil 1)
    ("\\args" "std::cout << \"\\n\\n\"; for (int s = 0; s < argc; s++) std::cout << argv[s]  << ' '; std::cout << \"\\n\\n\";" nil 1)
    ("\\str" "std::string " nil 3)
    ("\\ei" "#endif" nil 1)
    ("\\st" "std::string " nil 279)
    ("\\td" "// TODO(oalexan1): " nil 428)
    ("\\sr" "std::string " nil 1)
    ("else" "else" c-electric-continued-statement 3)
    ("couts" "std::cout << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 4355)
    ("\\sp" "std::shared_ptr" nil 6)
    ("\\spr" "sprintf(, \"%d\", );" (lambda nil (interactive) (beginning-of-line) (search-forward "\"")) 11)
    ("cout" "std::cout <<  << std::endl;" (lambda nil (interactive) (search-backward " <<") (c-indent-command)) 964)
    ("xxx" "xxx " nil 27)
    ("\\os" "std::ostringstream " nil 0)
    ("coutp" "std::cout.precision();" (lambda nil (interactive) (search-backward ")") (c-indent-command)) 81)
    ("\\ofs" "std::ofstream (\"\");" (lambda nil (interactive) (search-backward "(")) 17)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 272)
    ("catch" "catch" c-electric-continued-statement 0)
    ("\\vw" "vw_out() << \"\\n\";" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (backward-char 2) (c-indent-command)) 16)
    ("\\lf" "LOG(FATAL) << " nil 10)
    ("\\sti" "static_cast<int>" nil 27)
    ("if" "" c++-if 3264)
    ("\\lfs" "LOG(FATAL) << \"\\n\";" (lambda nil (interactive) (backward-char 4)) 79)
    ...
    ("\\vv" "vw::Vector " nil 80)
    ("\\si" ".size()" nil 717)
    ("\\vs" "std::vector<std::string>" nil 36)
    ("\\std" "static_cast<double>" nil 13)
    ("\\inc" "#include <>" backward-char 202)
    ("\\rs" ".resize()" backward-char 120)
    ("coute" "std::cout << std::endl;" nil 80)
    ("\\v3" "vw::Vector3 " nil 84)
    ("\\if0" "#if 0" nil 1)
    ("cerr" "std::cerr << \"\" << std::endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 907)
    ("\\v2" "vw::Vector2 " nil 56)
...
(define-abbrev-table 'python-mode-abbrev-table '(
    ...
    ("print" "print(\"\")" (lambda nil (interactive) (search-backward "\"")) 426)
    ))
...
(define-abbrev-table 'sh-mode-abbrev-table '(
    ("\\x" "exit 0" nil 3)
    ("\\xx" "exit 0" nil 5)
    ("\\ms" "message(STATUS \"\")" (lambda nil (interactive) (search-backward "\"")) 3)
    ("\\pl" "perl -pi -e \"s###g\"" (lambda nil (interactive) (search-backward "##")) 59)
    ("\\td" "# TODO(oalexan1): " nil 26)
    ("\\xxx" "exit 0" nil 0)
    ("pl" "perl -pi -e \"s###g\"" (lambda nil (interactive) (search-backward "##")) 67)
    ))
...
(define-abbrev-table 'fundamental-mode-abbrev-table '(
    ("\\nr" ":numref:``" backward-char 300)
    ("\\m" ":math:``" backward-char 0)
    ("\\ur" "` <>`_" nil 10)
    ("\\ci" ":cite:``" backward-char 39)
    ("\\ms" "message(STATUS \"\")" nil 0)
    ("\\url" "`val <http>`_" nil 2)
    ("\\td" "TODO(oalexan1): " nil 9)
    ("\\sec" ".. _:" backward-char 14)
    ))
