...
"</li>\n"
"<li> Enforce that all polygon edges have angles multiple of 45 degrees and snap the \n"
...
"  interactively translated using Shift-Mouse and rotated/flipped from \n"
...
"                                     up in the given color(the default is to use the colors specified in the polygon files)\n"
"</td>\n"
"</tr>\n"
"<tr>\n"
...
"<tr>\n"
"<td>-p | -points   </td>\n"
"<td>All polygons after this option will show up as vertices rather than edges (a subsequent -p option undoes this behavior)\n"
"\n"
"</td>\n"
"</tr>\n"
"<tr>\n"
