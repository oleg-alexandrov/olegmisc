...
stereo_gui: Fix panning and zooming in color mode.

stereo_gui: Make overlay and georeferences work in color mode. Compute a pixel only from the top-most image.
...
// Must support u, v, w throughout the codebase, especially when initializing
// cameras with GCP in cam_gen and bundle_adjust.
