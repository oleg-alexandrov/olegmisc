...
# named like ${prefix}f-00000.tif, ${prefix}f-00000.tsai, and analogously for Nadir and
...
# Also can handle any other single-character above, such as '1', '2', etc. Ensure
# these entries are used as part of the 'types' variable below.
