...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("\\f" ".front()" nil 0)
    ("\\gd" "Geom_Dbu" nil 200)
    ("\\inc" "#include <>" backward-char 74)
    ("\\incl" "#include \"\"" backward-char 56)
    ("\\n" "NULL" nil 0)
    ("\\ofs" "ofstream (\"\");" (lambda nil (interactive) (search-backward "(")) 2)
    ("\\p" ".push_back();" (lambda nil (interactive) (search-backward ")")) 0)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 63)
    ("\\rs" ".resize()" backward-char 62)
    ("\\si" ".size()" nil 187)
    ...
    ("cerr" "cerr << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 874)
    ("cin" "cin >> " nil 9)
    ("co2" "cout.precision(20);" nil 1)
    ("cout" "cout <<  << endl;" (lambda nil (interactive) (search-backward " <<") (c-indent-command)) 854)
    ("coute" "cout << endl;" nil 11)
    ("coutp" "cout.precision();" nil 4)
    ("couts" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 1426)
    ("else" "else" c-electric-continued-statement 69)
    ("for" "" c++-for 1033)
    ("if" "" c++-if 1415)
    ("ints" "int*" nil 3)
    ...
    ("teh" "the " nil 54)
    ("uns" "using namespace std;" nil 24)
    ("while" "while" c-electric-continued-statement 16)
    ("xxx" "exit(0);" nil 16)
    ))
...
(define-abbrev-table 'cperl-mode-abbrev-table '(
    ...
    ("\\ar" "$ARGV[]" (lambda nil (interactive) (forward-char -1)) 25)
    ("\\cf" "close(FILE);" cperl-indent-command 131)
    ("\\f" "<FILE>" nil 45)
    ("\\m" "=~ //" (lambda nil (interacive) (backward-char 1)) 0)
    ("\\of" "open (FILE, \":utf8\", \"\");" (lambda nil (interactive) (backward-char 3)) 57)
    ("\\ofr" "open(FILE, \"<\");" (lambda nil (interactive) (search-backward "\"")) 57)
    ("\\ofw" "open(FILE, \">\");" (lambda nil (interactive) (search-backward "\"")) 36)
    ("\\pf" "print FILE \"\\n\";" (lambda nil (interactive) (forward-char -4)) 67)
    ("\\sp" "split(\"\\n\", )" (lambda nil (interactive) (forward-char -1)) 25)
    ...
    ("else" "" perl-else 151)
    ("for" "" perl-for 132)
    ("foreach" "" perl-foreach 208)
    ("if" "" perl-if 434)
    ("opf" "open (FILE, \":utf8\", \"\");" (lambda nil (interactive) (backward-char 3)) 1)
    ("print" "" perl-print 771)
    ("sg" "" subst-globally 362)
...
(define-abbrev-table 'matlab-mode-abbrev-table '(
    ...
    ("dsp" "disp(sprintf('%'));" (lambda nil (indent-according-to-mode) (search-backward "%")) 242)
    ("dsr" "display(sprintf('%0.9g'))" nil 1)
    ("fch" "figure(); clf; hold on;" (lambda nil (interactive) (search-backward ")")) 19)
    ("for" "" matlab-for 340)
    ("if" "" matlab-if 283)
...
(define-abbrev-table 'python-mode-abbrev-table '(
    ("print" "print \"\"" (lambda nil (interactive) (search-backward "\"")) 49)
    ))
