...
(define-abbrev-table 'c++-mode-abbrev-table '(
    ...
    ("\\gb" "Geom_Bln " nil 61)
    ("\\gd" "Geom_Dbu" nil 308)
    ("\\inc" "#include <>" backward-char 94)
    ("\\incl" "#include \"\"" backward-char 73)
    ("\\n" "\\n" nil 17)
    ("\\ofs" "ofstream (\"\");" (lambda nil (interactive) (search-backward "(")) 3)
    ("\\p" ".push_back();" (lambda nil (interactive) (search-backward ")")) 0)
    ("\\pb" ".push_back();" (lambda nil (interactive) (search-backward ")")) 104)
    ("\\rs" ".resize()" backward-char 86)
    ("\\si" ".size()" nil 246)
    ...
    ("cerr" "cerr << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 881)
    ("cin" "cin >> " nil 9)
    ("co2" "cout.precision(20);" nil 1)
    ("cout" "cout <<  << endl;" (lambda nil (interactive) (search-backward " <<") (c-indent-command)) 882)
    ("coute" "cout << endl;" nil 17)
    ("coutp" "cout.precision();" nil 7)
    ("couts" "cout << \"\" << endl;" (lambda nil (interactive) (setq smart_forward_flag 1) (search-backward "\"") (c-indent-command)) 1643)
    ("else" "else" c-electric-continued-statement 0)
    ("for" "" c++-for 1218)
    ("if" "" c++-if 1678)
    ("ints" "int*" nil 3)
...
(define-abbrev-table 'cperl-mode-abbrev-table '(
    ...
    ("\\ar" "$ARGV[]" (lambda nil (interactive) (forward-char -1)) 28)
    ("\\cf" "close(FILE);" cperl-indent-command 142)
    ("\\f" "<FILE>" nil 53)
    ("\\m" "=~ //" (lambda nil (interacive) (backward-char 1)) 0)
    ("\\of" "open (FILE, \":utf8\", \"\");" (lambda nil (interactive) (backward-char 3)) 57)
    ("\\ofr" "open(FILE, \"<\");" (lambda nil (interactive) (search-backward "\"")) 65)
    ("\\ofw" "open(FILE, \">\");" (lambda nil (interactive) (search-backward "\"")) 39)
    ("\\pf" "print FILE \"\\n\";" (lambda nil (interactive) (forward-char -4)) 70)
    ("\\sp" "split(\"\\n\", )" (lambda nil (interactive) (forward-char -1)) 30)
    ...
    ("else" "" perl-else 155)
    ("for" "" perl-for 136)
    ("foreach" "" perl-foreach 224)
    ("if" "" perl-if 461)
    ("opf" "open (FILE, \":utf8\", \"\");" (lambda nil (interactive) (backward-char 3)) 1)
    ("print" "" perl-print 812)
    ("sg" "" subst-globally 372)
...
(define-abbrev-table 'f90-mode-abbrev-table '(
    ...
    ("`wh" "where" nil 0)
    ("`wr" "write" nil 0)
    ("print" "print *, \"\"" (lambda nil (interactive) (search-backward "\"")) 89)
    ("write" "write (*, *) " nil 3)
    ))
...
(define-abbrev-table 'matlab-mode-abbrev-table '(
    ...
    ("dsp" "disp(sprintf('%'));" (lambda nil (indent-according-to-mode) (search-backward "%")) 258)
    ("dsr" "display(sprintf('%0.9g'))" nil 1)
    ("fch" "figure(); clf; hold on;" (lambda nil (interactive) (search-backward ")")) 27)
    ("for" "" matlab-for 347)
    ("if" "" matlab-if 298)
