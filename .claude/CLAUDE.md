...
`~/.claude/CLAUDE.md` is the real file. `~/.gemini/GEMINI.md` symlinks to it.
...
- "Project dir" or "projects dir" means `~/projects`. This file (GEMINI.md / CLAUDE.md) is the shared long-term memory - they are symlinked and synonymous.
